...
```{r}
lepto_search <- entrez_search(db="nuccore", term = "Calileptoneta[organism]", retmax=1)
lepto_search
```
#### Ornithorhynchus anatinus is an organim.

2. Use `entrez_fetch()` to return your database hits as a character vector.
```{r}
lepto_search <- entrez_fetch(db="nuccore", id=lepto_search$ids, rettype="fasta")
lepto_search 
```
